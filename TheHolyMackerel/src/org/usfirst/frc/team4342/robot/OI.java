...
public class OI
{
	...
	private DigitalInput limitLeft = new DigitalInput(0);
	private DigitalInput limitRight = new DigitalInput(0);
	...
	public Accumulator acc = new Accumulator(v0, v1, s0, limitLeft, limitRight);
